			...
			<div class="panel panel-default">
  				<div class="panel-heading"></div>
  					<table class="table">
        				...
        				<tbody>
        					<s:iterator value="userReservation" var="it">
         				 		<tr>
         				 			<s:if test="#it.stateFlag==0">
				            		<td><s:property value="#it.reservationName"/></td>
				            		<td><s:property value="#it.sportsName"/></td>
				            		<td><s:property value="#it.place"/></td>
				            		<td>等待审核</td>
				            	 	</s:if>
				            	 	<s:elseif test="#it.stateFlag==1">
				            	 	<td><s:property value="#it.reservationName"/></td>
				            		<td><s:property value="#it.sportsName"/></td>
				            		<td><s:property value="#it.place"/></td>
				            		<td>等待接受</td>
				            	 	</s:elseif>
				            	 	<s:elseif test="it.stateFlag==2">
				            	 	<td><s:property value="#it.reservationName"/></td>
				            		<td><s:property value="#it.sportsName"/></td>
				            		<td><s:property value="#it.place"/></td>
				            		<td>已被接受</td>
				            	 	</s:elseif> 
				            	 	<s:elseif test="it.stateFlag==3">
				            	 	<td><s:property value="#it.reservationName"/></td>
				            		<td><s:property value="#it.sportsName"/></td>
				            		<td><s:property value="#it.place"/></td>
				            		<td>已过期</td>
