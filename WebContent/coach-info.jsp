  	...
  	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<ul class="nav nav-pills">
			    ...
			    %>
			    <li role="presentation"><a class="nav-brand" href="showusercourses.action" style="padding:0px"><img width="50px" alt="头像" src="${sessionScope.avatar}"></a></li>
			    <li role="presentation"><a class="active">${sessionScope.user}</a></li>
